...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/polished-breeze-aa5e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/polished-breeze-aa5e
```

A live public deployment of this template is available at [https://polished-breeze-aa5e.templates.workers.dev](https://polished-breeze-aa5e.templates.workers.dev)
